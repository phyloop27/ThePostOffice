"""
Django settings for ThePostOffice project.
...
ROOT_URLCONF = 'ThePostOffice.urls'
...
WSGI_APPLICATION = 'ThePostOffice.wsgi.application'
...
STATIC_URL = BASE_DIR/ 'ThePostOfficeApp/static/'
